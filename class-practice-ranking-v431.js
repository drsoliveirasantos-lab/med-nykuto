(function(){
  ...
  var copy = {
    es:{kicker:'CLASIFICACIÓN SEMANAL',title:'{score}/{total} respuestas correctas',intro:'Usa tu 4RAC para mantenerte anónimo, o el apodo que prefieras.',nickname:'4RAC o apodo',placeholder:'Ej.: 4RAC o Baboune',publish:'Sumar mis puntos',publishing:'Publicando…',invalid:'Escribe un 4RAC o apodo de 2 a 24 caracteres.',success:'Resultado publicado. Tus puntos ya cuentan para esta semana.',kept:'Tu mejor resultado de este bloque ya era igual o mejor.',error:'No se pudo publicar ahora. El ejercicio sigue guardado en este teléfono.',ranking:'Ver la clasificación'},
    br:{kicker:'CLASSIFICAÇÃO SEMANAL',title:'{score}/{total} respostas corretas',intro:'Use seu 4RAC para manter o anonimato, ou o apelido que preferir.',nickname:'4RAC ou apelido',placeholder:'Ex.: 4RAC ou Baboune',publish:'Somar meus pontos',publishing:'Publicando…',invalid:'Digite um 4RAC ou apelido de 2 a 24 caracteres.',success:'Resultado publicado. Seus pontos já contam para esta semana.',kept:'Seu melhor resultado deste bloco já era igual ou maior.',error:'Não foi possível publicar agora. O exercício continua salvo neste telefone.',ranking:'Ver a classificação'}
  };
