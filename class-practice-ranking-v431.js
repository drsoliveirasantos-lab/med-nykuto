(function(){
  ...
  var copy = {
    es:{kicker:'DESAFÍO 4.º E · 50 R$ PIX',title:'{score}/{total} respuestas correctas',intro:'Publica con tu perfil del 4.º E. La clasificación es provisional hasta la verificación manual.',identity:'Perfil público del desafío',missing:'Guarda primero tu nombre completo, catraca completa y confirmación del 4.º E.',publish:'Sumar mis puntos',publishing:'Publicando…',success:'Resultado publicado. Tus puntos ya cuentan provisionalmente esta semana.',kept:'Tu mejor resultado de este bloque ya era igual o mejor.',closed:'El desafío cerró el domingo a las 20:00, hora de Paraguay. El ejercicio sigue guardado, pero ya no cambia la clasificación.',error:'No se pudo publicar ahora. El ejercicio sigue guardado en este teléfono.',ranking:'Abrir desafío y clasificación',register:'Guardar identidad'},
    br:{kicker:'DESAFIO 4.º E · R$ 50 PIX',title:'{score}/{total} respostas corretas',intro:'Publique com seu perfil do 4.º E. A classificação é provisória até a verificação manual.',identity:'Perfil público do desafio',missing:'Primeiro salve seu nome completo, catraca completa e confirmação do 4.º E.',publish:'Somar meus pontos',publishing:'Publicando…',success:'Resultado publicado. Seus pontos já contam provisoriamente nesta semana.',kept:'Seu melhor resultado deste bloco já era igual ou melhor.',closed:'O desafio encerrou domingo às 20:00, horário do Paraguai. O exercício continua salvo, mas não altera mais a classificação.',error:'Não foi possível publicar agora. O exercício continua salvo neste telefone.',ranking:'Abrir desafio e classificação',register:'Salvar identidade'}
  };
