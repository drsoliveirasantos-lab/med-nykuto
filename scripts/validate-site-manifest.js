...
if(manifest){
  ...
  if(manifest.release !== 'v372-answer-length-balance') add('manifest: wrong release');
  ...
  if(!manifest.safeguards || manifest.safeguards.practiceLoaderCacheVersion !== 'v372') add('manifest: practice loader cache version must be v372');
