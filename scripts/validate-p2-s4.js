...
expect(html.indexOf('class-p1-v1.js?v=503') > html.indexOf('p2-s4-e-v1.js?v=494'), 'p1.html must load both scopes before the shared runtime.');
expect(/class-p1-v1\.css\?v=503/.test(html), 'The shared partial-review stylesheet cache key must be 503.');
...
expect(/function updateSubjectRailVisibility/.test(runtime) && /!customize\.open/.test(runtime) && /state\.practicePreset/.test(runtime), 'Quick presets and advanced subject filters must never be visible together.');
