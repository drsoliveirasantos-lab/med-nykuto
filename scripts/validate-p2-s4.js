...
expect(html.indexOf('class-p1-v1.js?v=502') > html.indexOf('p2-s4-e-v1.js?v=494'), 'p1.html must load both scopes before the shared runtime.');
expect(/class-p1-v1\.css\?v=502/.test(html), 'The shared partial-review stylesheet cache key must be 502.');
