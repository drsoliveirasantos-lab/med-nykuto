...
expect(i18n.includes("'Filtrar avisos':'Filtrar avisos'") && i18n.includes("'Filtrar por tipo de aviso':'Filtrar por tipo de aviso'") && html.includes('grupo-3-i18n-v421.js?v=501'), 'The notice filter accessibility labels or updated i18n cache version are missing.');
expect(i18n.includes('Faça com que conte os carbonos') && i18n.includes('diferencie a transferência C2 da transcetolase e a C3 da transaldolase'), 'The enriched Andrea López teacher prompt is not fully localized in Portuguese.');
