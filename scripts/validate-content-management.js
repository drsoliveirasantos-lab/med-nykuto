...
if (!failures.length) {
  ...
  expect(html.includes('href="/gestion-v440.css?v=487"') && html.includes('src="/gestion-v440.js?v=486"'), 'The management content assets are not cache-busted at the current versions.');
