...
if (model) {
  ...
  expect(/academic-model-v445\.js/.test(html) && /academic-model-2026-08-27-v494\.js/.test(html) && /academic-model-2026-08-28-v500\.js/.test(html) && /s4-course-themes-v182\.js\?v=182/.test(html) && /class-notebook-v445\.js\?v=510/.test(html), 'Class page does not load the complete academic model, evolving course themes and current academic notebook.');
  ...
  const notebookIndex = html.indexOf('class-notebook-v445.js?v=510');
