...
async function validateMulticlassShell() {
  ...
  expect(managementHtml.includes('src="/gestion-v440.js?v=486"') && managementHtml.includes('href="/gestion-v440.css?v=487"'), 'The nested management route does not use the current absolute asset versions.');
