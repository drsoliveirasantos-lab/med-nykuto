...
async function validateMulticlassShell() {
  ...
  expect(legacyClassRuntime.includes('function setupNoticeTicker') && legacyClassRuntime.includes("addEventListener('pointerdown'") && legacyClassRuntime.includes("setInterval(function(){show(active+1);},3200)"), 'The 4.º E Home notice ticker is missing automatic rotation or press-to-pause support.');
