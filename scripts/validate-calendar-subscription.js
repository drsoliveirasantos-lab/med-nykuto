...
async function main() {
  ...
  assert.ok(html.includes('/turma-v471.css?v=487') && html.includes('/turma-v471.js?v=487'), 'Turma shell cache-busting version is stale.');
  ...
  assert.ok(worker.includes("med-nykuto-shell-v487") && worker.includes("/turma-v471.js?v=487") && worker.includes("/turma-v471.css?v=487") && worker.includes("/calendar-subscription-v485.js?v=485"), 'Service worker does not precache the current turma and calendar assets.');
