...
assert.ok(worker.includes("med-nykuto-shell-v487") && worker.includes('/public-theme-v485.css?v=486') && worker.includes('/public-theme-v485.js?v=485'), 'The current service-worker shell does not cache the shared theme assets.');
