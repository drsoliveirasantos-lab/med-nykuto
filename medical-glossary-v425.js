(function(){
  ...
  var VERSION = 'v432-global-medical-glossary';
  ...
  var entries = [
    ...
    {key:'dermatophytosis',forms:['dermatofitosis'],es:'Micosis cutánea causada por dermatofitos en piel, pelo o uñas.',br:'Micose cutânea causada por dermatófitos na pele, cabelo ou unhas.'},
    ...
    {key:'stratum-corneum',forms:['estrato córneo'],es:'Capa más externa de la epidermis, formada por células ricas en queratina.',br:'Camada mais externa da epiderme, formada por células ricas em queratina.'},
    {key:'lipophilic',forms:['lipofílica','lipofílico','lipofílicas','lipofílicos'],es:'Que tiene afinidad por las grasas o crece mejor donde hay más lípidos.',br:'Que tem afinidade por gorduras ou cresce melhor onde há mais lipídios.'},
    {key:'zoophilic',forms:['zoofílica','zoofílico','zoofílicas','zoofílicos'],es:'Que se relaciona principalmente con animales y puede transmitirse desde ellos.',br:'Que se relaciona principalmente com animais e pode ser transmitido por eles.'},
    ...
    {key:'macroconidium',forms:['macroconidio','macroconidios','macroconídio','macroconídios'],es:'Espora asexual grande de algunos hongos; su forma y pared ayudan a identificarlos.',br:'Esporo assexuado grande de alguns fungos; sua forma e parede ajudam na identificação.'},
    {key:'hyaline',forms:['hialina','hialinas','hialino','hialinos'],es:'De aspecto claro o sin pigmento oscuro al microscopio.',br:'De aspecto claro ou sem pigmento escuro ao microscópio.'},
    {key:'septate',forms:['septada','septadas','septado','septados'],es:'Dividido en compartimentos por paredes internas llamadas septos.',br:'Dividido em compartimentos por paredes internas chamadas septos.'},
    {key:'tumefaction',forms:['tumefacción','tumefação'],es:'Aumento visible del volumen de una parte del cuerpo.',br:'Aumento visível do volume de uma parte do corpo.'},
    ...
    {key:'sodium-ion',forms:['Na⁺','Na+'],es:'Ion sodio con carga positiva; su entrada favorece la despolarización neuronal.',br:'Íon sódio com carga positiva; sua entrada favorece a despolarização do neurônio.',full:{es:'Ion sodio',br:'Íon sódio'},parts:{es:[['Na','Símbolo químico del sodio'],['+','Carga positiva']],br:[['Na','Símbolo químico do sódio'],['+','Carga positiva']]}},
    {key:'potassium-ion',forms:['K⁺','K+'],es:'Ion potasio con carga positiva; su salida participa en la repolarización.',br:'Íon potássio com carga positiva; sua saída participa da repolarização.',full:{es:'Ion potasio',br:'Íon potássio'},parts:{es:[['K','Símbolo químico del potasio'],['+','Carga positiva']],br:[['K','Símbolo químico do potássio'],['+','Carga positiva']]}},
    {key:'calcium-ion',forms:['Ca²⁺','Ca2+'],es:'Ion calcio con dos cargas positivas; en la terminal presináptica ayuda a liberar neurotransmisores.',br:'Íon cálcio com duas cargas positivas; no terminal pré-sináptico ajuda a liberar neurotransmissores.',full:{es:'Ion calcio',br:'Íon cálcio'},parts:{es:[['Ca','Símbolo químico del calcio'],['2+','Dos cargas positivas']],br:[['Ca','Símbolo químico do cálcio'],['2+','Duas cargas positivas']]}},
    {key:'chloride-ion',forms:['Cl⁻','Cl-'],es:'Ion cloruro con carga negativa; su entrada puede hacer la neurona más negativa e inhibirla.',br:'Íon cloreto com carga negativa; sua entrada pode deixar o neurônio mais negativo e inibi-lo.',full:{es:'Ion cloruro',br:'Íon cloreto'},parts:{es:[['Cl','Símbolo químico del cloro en forma de cloruro'],['−','Carga negativa']],br:[['Cl','Símbolo químico do cloro na forma de cloreto'],['−','Carga negativa']]}},
    ...
    {key:'myelin',forms:['mielina'],es:'Capa aislante que rodea ciertos axones y permite que la señal viaje más rápido.',br:'Camada isolante que envolve certos axônios e permite que o sinal viaje mais rápido.'},
    ...
    {key:'ionotropic',forms:['ionotrópico','ionotrópicos','ionotrópica','ionotrópicas'],es:'Receptor que también funciona como canal: el neurotransmisor se une y el canal se abre directamente.',br:'Receptor que também funciona como canal: o neurotransmissor se liga e o canal se abre diretamente.'},
    {key:'metabotropic',forms:['metabotrópico','metabotrópicos','metabotrópica','metabotrópicas'],es:'Receptor que activa proteínas intermediarias antes de cambiar un canal u otro proceso celular.',br:'Receptor que ativa proteínas intermediárias antes de modificar um canal ou outro processo celular.'},
    {key:'g-protein',forms:['proteína G','proteínas G'],es:'Proteína que transmite dentro de la célula la señal recibida por ciertos receptores.',br:'Proteína que transmite dentro da célula o sinal recebido por certos receptores.'},
    {key:'acetylcholine',forms:['acetilcolina'],es:'Neurotransmisor liberado por varias neuronas; su efecto depende del receptor que encuentra.',br:'Neurotransmissor liberado por vários neurônios; seu efeito depende do receptor encontrado.'},
    {key:'acetylcholinesterase',forms:['acetilcolinesterasa','acetilcolinesterase'],es:'Enzima que degrada la acetilcolina y ayuda a terminar su señal en la sinapsis.',br:'Enzima que degrada a acetilcolina e ajuda a encerrar seu sinal na sinapse.'},
    {key:'gaba',forms:['GABA'],es:'Neurotransmisor inhibidor que en la clase se relacionó con la entrada de cloruro.',br:'Neurotransmissor inibitório que na aula foi relacionado à entrada de cloreto.',full:{es:'Ácido gamma-aminobutírico',br:'Ácido gama-aminobutírico'},parts:{es:[['G','Gamma'],['A','Amino'],['B','Butírico'],['A','Ácido']],br:[['G','Gama'],['A','Amino'],['B','Butírico'],['A','Ácido']]}},
    {key:'glutamate',forms:['glutamato'],es:'Neurotransmisor presentado en la clase como habitualmente excitador.',br:'Neurotransmissor apresentado na aula como geralmente excitatório.'},
    {key:'nociceptor',forms:['nociceptor','nociceptores'],es:'Receptor sensitivo que detecta estímulos capaces de dañar un tejido.',br:'Receptor sensitivo que detecta estímulos capazes de lesar um tecido.'},
    {key:'thermoreceptor',forms:['termorreceptor','termorreceptores'],es:'Receptor sensitivo que detecta cambios de temperatura.',br:'Receptor sensitivo que detecta mudanças de temperatura.'},
    {key:'photoreceptor',forms:['fotorreceptor','fotorreceptores'],es:'Receptor sensitivo que detecta la luz.',br:'Receptor sensitivo que detecta a luz.'},
    {key:'sensory-transduction',forms:['transducción sensorial','transdução sensorial'],es:'Conversión de la energía de un estímulo en una señal eléctrica del receptor.',br:'Conversão da energia de um estímulo em um sinal elétrico do receptor.'},
    {key:'spatial-summation',forms:['sumación espacial','somação espacial'],es:'Suma de señales que llegan desde varias neuronas al mismo tiempo.',br:'Soma de sinais que chegam de vários neurônios ao mesmo tempo.'},
    {key:'temporal-summation',forms:['sumación temporal','somação temporal'],es:'Suma de impulsos repetidos que llegan muy próximos en el tiempo desde una misma entrada.',br:'Soma de impulsos repetidos que chegam muito próximos no tempo pela mesma entrada.'},
    {key:'divergence',forms:['divergencia','divergência'],es:'Una señal se reparte desde una neurona hacia varias y puede amplificarse.',br:'Um sinal se distribui de um neurônio para vários e pode ser amplificado.'},
    {key:'convergence',forms:['convergencia','convergência'],es:'Varias señales llegan a una misma neurona y se integran.',br:'Vários sinais chegam ao mesmo neurônio e são integrados.'},
    {key:'reverberating-circuit',forms:['circuito reverberante'],es:'Circuito en el que la señal vuelve a entrar y prolonga la respuesta después del estímulo inicial.',br:'Circuito em que o sinal volta a entrar e prolonga a resposta após o estímulo inicial.'},
    {key:'synaptic-fatigue',forms:['fatiga sináptica','fadiga sináptica'],es:'Disminución temporal de la transmisión cuando una sinapsis trabaja de forma sostenida.',br:'Diminuição temporária da transmissão quando uma sinapse trabalha continuamente.'},
