(function(){
  ...
  var topics = {
    nutricion:{
      ...
      facts:[
        ...
        fact('armonia','la armonía','Los grupos de alimentos deben guardar relación entre sí; ni una ensalada sola ni un plato dominado por almidones es completo.','La armonía busca una proporción equilibrada entre grupos de alimentos.',['La armonía significa comer un solo grupo en cada comida.','La armonía se mide únicamente por el tamaño total del plato.','La armonía exige que todos los alimentos tengan el mismo color.'],'Un plato dominado por un solo grupo siempre cumple la ley de armonía.'),
        fact('adecuacion','la adecuación','Considera etapa de vida, patología, cultura, preferencias, economía, disponibilidad, dentición, deglución y capacidad para preparar alimentos.','La adecuación adapta la alimentación a la persona y a su contexto real.',['La adecuación aplica el mismo consejo a cualquier paciente.','La adecuación ignora cultura, economía y capacidad funcional.','La adecuación depende solo de que el plato sea visualmente atractivo.'],'La adecuación no cambia con la etapa de vida, la enfermedad ni el contexto.'),
        ...
        fact('balance','el balance energético','Si la ingesta energética supera de forma sostenida al gasto, se favorece el almacenamiento; si queda por debajo, se movilizan reservas.','El balance depende de la relación acumulada entre ingesta y gasto.',['El balance depende únicamente del peso observado en un solo día.','El balance siempre es positivo aunque la ingesta quede bajo el gasto.','El balance no guarda relación con la ingesta ni con el gasto.'],'Cuando la ingesta queda de forma sostenida por debajo del gasto, se favorece el almacenamiento.'),
        fact('plato','la técnica del plato','½ Verduras y frutas','El modelo del plato dedica la mitad a verduras y frutas.',['El modelo del plato dedica la mitad únicamente a proteínas.','El modelo del plato elimina cereales, tubérculos y legumbres.','El modelo del plato prescribe la misma cantidad exacta a todos.'],'En la técnica del plato, la mitad corresponde únicamente a proteínas.'),
        fact('energeticos','los alimentos energéticos','Principalmente carbohidratos y grasas','Los alimentos energéticos aportan principalmente carbohidratos y grasas.',['Los alimentos energéticos aportan exclusivamente vitaminas y agua.','Los alimentos energéticos son solamente carnes, huevos y lácteos.','Los alimentos energéticos no participan en el aporte de energía.'],'Los alimentos energéticos aportan principalmente agua y no carbohidratos ni grasas.'),
        fact('enriquecido','un alimento enriquecido','En clase se usa para describir la reposición de nutrientes perdidos durante el procesamiento, como vitaminas del grupo B y hierro en harinas refinadas.','En clase, enriquecido significa reponer nutrientes perdidos al procesar.',['En clase, enriquecido significa retirar micronutrientes del alimento.','En clase, enriquecido significa cultivar sin añadir ni reponer nutrientes.','En clase, enriquecido significa que el alimento no fue procesado.'],'En clase, enriquecido significa eliminar nutrientes durante el procesamiento.')
      ]
    },
    'fisiologia-2026-08-13':{
      ...
      facts:[
        ...
        fact('grv','el grupo respiratorio ventral','Contiene neuronas inspiratorias y espiratorias; participa especialmente cuando aumenta la demanda. Incluye el complejo pre-Bötzinger, clave para generar ritmo.','El GRV contiene neuronas inspiratorias y espiratorias y participa más con demanda alta.',['El GRV contiene solo neuronas sensitivas del cuerpo carotídeo.','El GRV deja de participar cuando aumenta la demanda respiratoria.','El GRV se limita a controlar el habla desde la corteza motora.'],'El grupo respiratorio ventral deja de participar cuando aumenta la demanda.'),
        fact('grp','el grupo respiratorio pontino','Modula la transición entre inspiración y espiración.','El grupo pontino modula el paso entre inspiración y espiración.',['El grupo pontino mide directamente la PaO₂ en la sangre.','El grupo pontino produce el surfactante de los alvéolos.','El grupo pontino transporta el oxígeno unido a hemoglobina.'],'El grupo respiratorio pontino no participa en la transición respiratoria.'),
        ...
        fact('epoc','el caso de EPOC','Una espiración prolongada, sibilancias y un FEV₁ reducido orientan a obstrucción.','Espiración prolongada, sibilancias y FEV₁ reducido orientan a obstrucción.',['Una espiración prolongada y sibilancias orientan siempre a restricción.','Un FEV₁ reducido descarta cualquier problema obstructivo.','La obstrucción se reconoce únicamente por una PaO₂ normal.'],'En el caso de clase, las sibilancias y el FEV₁ reducido descartan obstrucción.')
      ]
    },
    'fisiologia-2026-08-10':{
      ...
      facts:[
        ...
        fact('bohr','el efecto Bohr','La curva se desplaza a la derecha y facilita la descarga de O₂ en tejidos activos.','El efecto Bohr desplaza la curva a la derecha y facilita liberar O₂.',['El efecto Bohr desplaza la curva a la izquierda y bloquea toda descarga.','El efecto Bohr describe únicamente el transporte de bicarbonato.','El efecto Bohr elimina la hemoglobina de la sangre.'],'El efecto Bohr desplaza la curva a la izquierda y dificulta liberar O₂.'),
    ...
    bioquimica:{
      ...
      facts:[
        ...
        fact('lugar','el lugar de la glucólisis','Ocurre en el citosol y puede continuar aunque no haya suficiente oxígeno.','La glucólisis ocurre en el citosol y puede continuar con poco oxígeno.',['La glucólisis ocurre únicamente dentro del núcleo celular.','La glucólisis necesita oxígeno como sustrato directo obligatorio.','La glucólisis ocurre solo en la membrana mitocondrial interna.'],'La glucólisis ocurre solo en la mitocondria y necesita O₂ directamente.'),
        fact('balance','el balance neto','2 piruvatos + 2 ATP + 2 NADH','Por cada glucosa, el balance neto incluye 2 piruvatos, 2 ATP y 2 NADH.',['Por cada glucosa, el balance neto es 1 piruvato y ningún ATP.','Por cada glucosa, el balance neto es 4 piruvatos y 8 ATP.','Por cada glucosa, se consumen todos los ATP sin formar NADH.'],'El balance neto por glucosa es un piruvato, cero ATP y cero NADH.'),
    ...
    epidemiologia:{
      ...
      facts:[
        ...
        fact('paraguay','la APS en Paraguay','2008: implementación de la estrategia APS en Paraguay.','La implementación de la estrategia APS en Paraguay se sitúa en 2008.',['La implementación de APS en Paraguay se sitúa en 1978.','La implementación de APS en Paraguay se sitúa en 2018.','La implementación de APS en Paraguay se sitúa en 2026.'],'La clase sitúa el inicio de la estrategia APS en Paraguay en 1978.'),
        fact('principios','los principios de APS','Equidad y cobertura universal.','Equidad y cobertura universal forman parte de los principios de APS.',['Selección por capacidad de pago es un principio de APS.','Atención distante de la comunidad es un principio de APS.','Trabajo sin participación comunitaria es un principio de APS.'],'La selección por capacidad de pago es un principio central de la APS.'),
        ...
        fact('sectorizacion','la sectorización','Su objetivo es identificar y vigilar familias o comunidades con riesgo sanitario y distribuir recursos con equidad.','La sectorización identifica riesgos y ayuda a distribuir recursos con equidad.',['La sectorización divide a las personas según su capacidad de pago.','La sectorización evita asignar responsables a cada territorio.','La sectorización elimina el seguimiento de familias de riesgo.'],'La sectorización busca evitar la vigilancia de riesgos y la distribución equitativa.'),
        fact('triage','el triage','Prioriza por gravedad clínica; no por orden de llegada.','El triage prioriza por gravedad clínica y no por orden de llegada.',['El triage atiende siempre por orden de llegada sin excepciones.','El triage clasifica únicamente por edad y número de acompañantes.','El triage sustituye el diagnóstico y el tratamiento definitivo.'],'El triage debe seguir únicamente el orden de llegada.'),
        fact('emergencia','la emergencia','Existe amenaza vital o de órgano y no puede esperar.','Una emergencia implica amenaza vital o de órgano y atención inmediata.',['Una emergencia es una consulta estable que puede esperar sin riesgo.','Una emergencia se decide solo por la percepción del acompañante.','Una emergencia nunca requiere interrumpir una actividad menos urgente.'],'Una emergencia puede esperar porque no existe amenaza vital ni de órgano.')
      ]
    },
    'microbiologia-teorica':{
      ...
      facts:[
        ...
        fact('caso','el caso de clase','El conjunto orienta a tiña capitis inflamatoria','El caso del niño con alopecia, pelos fracturados y contacto con perro orienta a tiña capitis inflamatoria.',['El caso orienta únicamente a una infección bacteriana de la uña.','El caso descarta una lesión del cuero cabelludo y del pelo.','El caso orienta a tinea cruris sin necesidad de confirmación.'],'El caso de alopecia y pelos fracturados descarta una tiña capitis.'),
        fact('muestra','la muestra en dermatofitosis','Raspado del borde activo; pelo/escama en capitis; recorte y detrito subungueal en uñas.','La muestra cambia según el sitio: borde, pelo o material ungueal.',['La misma muestra de sangre se usa obligatoriamente para todas las tiñas.','En capitis nunca se toman pelos ni escamas afectados.','En uñas se toma únicamente saliva y no material subungueal.'],'La muestra es igual para todos los sitios y nunca incluye pelo ni uña.'),
    ...
    'microbiologia-practica':{
      ...
      facts:[
        ...
        fact('muestra','la muestra para la práctica','Pan duro con moho','La muestra preferida es pan duro con moho dentro de un recipiente cerrado.',['La muestra preferida es un líquido abierto y sin identificar.','La muestra debe abrirse y olerse en casa antes de llevarla.','La muestra preferida es un alimento destinado todavía al consumo.'],'La muestra debe llevarse abierta y olerse antes de entrar al laboratorio.'),
        ...
        fact('dimorfico','el hongo dimórfico','Cambia de morfología según las condiciones','Un hongo dimórfico cambia de morfología según las condiciones.',['Un hongo dimórfico conserva siempre una única forma sin cambios.','Un hongo dimórfico es obligatoriamente una bacteria esférica.','Un hongo dimórfico no presenta forma ambiental ni tisular.'],'Un hongo dimórfico mantiene siempre la misma morfología.'),
        fact('hifa','la hifa','Filamento individual; puede ser septado o cenocítico.','Una hifa es un filamento individual que puede ser septado o cenocítico.',['Una hifa es el conjunto completo de todas las colonias bacterianas.','Una hifa es únicamente una espora sexual libre y sin filamento.','Una hifa es un medio de cultivo compuesto por agar y glucosa.'],'Una hifa es el conjunto de hifas y no un filamento individual.'),
        ...
        fact('conidios','los conidios','Tallo especializado que sostiene esporas asexuales externas.','El conidióforo sostiene conidios, que son esporas asexuales externas.',['El conidióforo contiene siempre un saco cerrado con esporangiosporas.','Los conidios son células humanas que forman el tejido muscular.','El conidióforo es el nombre del pH ácido del agar Sabouraud.'],'Los conidios se forman siempre dentro de un esporangio cerrado.'),
        ...
        fact('preparacion','la preparación observada','La demostración utilizó 10 g de polvo.','La demostración de clase utilizó 10 g de polvo con 100 mL de agua destilada.',['La demostración utilizó 100 g de polvo sin añadir agua.','La demostración sembró la muestra antes de preparar el medio.','La demostración indicó abrir y oler el cultivo durante el calentamiento.'],'La demostración utilizó 100 g de polvo sin agua destilada.')
      ]
    }
  };

  function explanationFor(item){
    return 'La respuesta sale directamente del curso: «' + item.evidence + '»';
  }

  function balancedOptions(item){
    var options = [item.correct].concat(item.wrong);
    var correctLength = options[0].length;
    var longestWrong = 1;
    for(var index=2;index<options.length;index+=1){
      if(options[index].length > options[longestWrong].length) longestWrong = index;
    }
    if(correctLength > options[longestWrong].length){
      options[longestWrong] = options[longestWrong].replace(/\.$/,'') + ' en todos los casos, sin ninguna excepción.';
    }
    return options;
  }
  ...
  function qcm(item,topic,variant){
    var question = {
      prompt:variant === 0
        ? 'Según la clase, ¿qué afirmación sobre ' + item.label + ' es correcta?'
        : 'Al repasar ' + item.label + ', ¿qué opción coincide con lo explicado en clase?',
  ...
  function application(item,topic){
    var question = {
      scenario:'Durante el repaso de este tema, un compañero duda sobre ' + item.label + ' y decide responder usando únicamente lo explicado en clase.',
      prompt:'En esta situación sobre ' + item.label + ', ¿qué respuesta coincide con el curso?',
      options:balancedOptions(item),
      answer:0,
      explanation:explanationFor(item)
    };
