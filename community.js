(function(){
  ...
  var messages = {
    es:{
      pageTitle:'P1 · Entrenamiento por tema y ranking | Med Nykuto',
      back:'Volver a P1',
      language:'Idioma',
      navHome:'Inicio',
      navSchedule:'Horario',
      ...
      navP1:'P1',
      eyebrow:'P1 · 4.º E',
      title:'P1 · Entrenamiento por tema y ranking',
      intro:'Elige una materia del P1, practica un tema y, si quieres, publica tu mejor resultado en el ranking semanal.',
      studyKicker:'P1 · ENTRENAMIENTO POR TEMA',
      selectSubject:'1 · Elige una materia',
      selectSubjectCopy:'Después verás solamente los temas de esa materia incluidos en P1.',
      selectTopic:'2 · Elige un tema',
      selectTopicCopy:'Cada opción corresponde a una clase incluida en el alcance P1.',
      oneTopic:'1 tema',
      topics:'{count} temas',
      ...
      rankingAndChallenge:'4.º E · CLASIFICACIÓN Y DESAFÍO',
      latestCourses:'TEMAS P1 RECIENTES',
      latestBiochemistry:'Bioquímica · Cori y pentosas',
      latestEpidemiology:'Epidemiología · Casos de triaje',
      newTranscript26:'Nueva transcripción · 26 ago.',
      ...
      rankingCopy:'Se suma el mejor resultado por materia o módulo, tanto desde los temas P1 como desde las prácticas individuales de clase. Desempate: más aciertos, mayor precisión y primer registro.',
      refresh:'Actualizar',
    ...
    br:{
      pageTitle:'P1 · Treino por tema e classificação | Med Nykuto',
      back:'Voltar ao P1',
      language:'Idioma',
      navHome:'Início',
      navSchedule:'Horário',
      ...
      navP1:'P1',
      eyebrow:'P1 · 4.º E',
      title:'P1 · Treino por tema e classificação',
      intro:'Escolha uma matéria do P1, pratique um tema e, se quiser, publique seu melhor resultado na classificação semanal.',
      studyKicker:'P1 · TREINO POR TEMA',
      selectSubject:'1 · Escolha uma matéria',
      selectSubjectCopy:'Depois você verá somente os temas dessa matéria incluídos no P1.',
      selectTopic:'2 · Escolha um tema',
      selectTopicCopy:'Cada opção corresponde a uma aula incluída no alcance do P1.',
      oneTopic:'1 tema',
      topics:'{count} temas',
      ...
      rankingAndChallenge:'4.º E · CLASSIFICAÇÃO E DESAFIO',
      latestCourses:'TEMAS RECENTES DO P1',
      latestBiochemistry:'Bioquímica · Cori e pentoses',
      latestEpidemiology:'Epidemiologia · Casos de triagem',
      newTranscript26:'Nova transcrição · 26 ago.',
      ...
      rankingCopy:'Somamos o melhor resultado por matéria ou módulo, tanto nos temas da P1 quanto nas práticas individuais das aulas. Desempate: mais acertos, maior precisão e primeiro registro.',
      refresh:'Atualizar',
