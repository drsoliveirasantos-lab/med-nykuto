(function(){
  ...
  var messages = {
    es:{
      ...
      latestPhysiology:'Fisiología · Organización y sinapsis',
      latestMicrobiology:'Micro teórica · Micosis y casos',
      newTranscript:'Nueva transcripción · 17 ago.',
      updatedTranscript:'Transcripción actualizada · 17 ago.',
    ...
    br:{
      ...
      latestPhysiology:'Fisiologia · Organização e sinapses',
      latestMicrobiology:'Micro teórica · Micoses e casos',
      newTranscript:'Nova transcrição · 17 ago.',
      updatedTranscript:'Transcrição atualizada · 17 ago.',
