(function () {
  ...
  model.narratives['bioquimica-2026-08-28'] = {
    ...
    sections: [
      ...
      ['Entrada regulada', 'La glucosa-6-fosfato deshidrogenasa controla el primer paso', 'La glucosa-6-fosfato deshidrogenasa (G6PD) oxida glucosa-6-fosfato y transfiere un hidruro a NADP+, formando NADPH y 6-fosfoglucono-δ-lactona. Es la reacción reguladora principal de la ruta.', 'La disponibilidad de NADP+ favorece el flujo, mientras una relación NADPH/NADP+ elevada lo frena. Oxidar el sustrato significa que pierde electrones; NADP+ se reduce al recibirlos.'],
      ['Fase oxidativa', 'Cada glucosa-6-fosfato genera dos NADPH, dióxido de carbono (CO₂) y una pentosa', 'La lactonasa hidrata la lactona y forma 6-fosfogluconato. Luego, la 6-fosfogluconato deshidrogenasa produce un segundo NADPH y realiza una descarboxilación oxidativa.', 'El producto carbonado es ribulosa-5-fosfato: la molécula inicial de seis carbonos libera uno como dióxido de carbono (CO₂) y conserva cinco. Esta fase es irreversible.'],
      ...
      ['Necesidad de nucleótidos', 'La célula puede priorizar ribosa sin fabricar NADPH innecesario', 'Cuando se requieren ribosa-5-fosfato y NADPH en proporciones semejantes, la fase oxidativa aporta ambos. La ribosa entra en la síntesis de ribonucleótidos para formar ácido ribonucleico (ARN) y cumplir otras funciones.', 'Si la demanda de ribosa supera a la de NADPH, la fase no oxidativa puede funcionar en sentido inverso desde fructosa-6-fosfato y gliceraldehído-3-fosfato. Parte de los ribonucleótidos se reduce después para aportar desoxirribonucleótidos al ácido desoxirribonucleico (ADN).'],
  ...
  model.narratives['epidemiologia-2026-08-28'] = {
    ...
    sections: [
      ['Mapa del sistema', 'Paraguay combina provisión pública, seguridad social, servicios institucionales y sector privado', 'El sistema no funciona como un proveedor único. El Ministerio de Salud Pública y Bienestar Social (MSPBS), el Instituto de Previsión Social (IPS), el Hospital de Clínicas, la sanidad militar y policial, y los prestadores privados atienden poblaciones y utilizan mecanismos de financiamiento diferentes.', 'La coexistencia de subsistemas puede ampliar opciones, pero también fragmentar información y continuidad. Los porcentajes de cobertura mencionados oralmente no se fijan aquí porque requieren una fuente oficial actualizada.'],
      ...
      ['Microred', 'La organización territorial empieza cerca del lugar donde vive la población', 'Las Unidades de Salud de la Familia (USF) y otros puntos de primer contacto se articulan en microredes locales con establecimientos distritales, regionales y de referencia nacional.', 'Conocer población, vías de acceso y barreras geográficas permite anticipar necesidades. Liderazgo, gobernanza y participación de actores locales sostienen la coordinación.'],
      ...
      ['Primer nivel', 'La Atención Primaria de Salud (APS) resuelve lo frecuente, previene y coordina el acceso', 'Las Unidades de Salud de la Familia realizan promoción, prevención, atención inicial, seguimiento y trabajo comunitario. También identifican riesgo y necesidad de derivación.', 'Primer nivel no significa atención de poca importancia. Es la puerta que evita fragmentación y mantiene el plan cuando el paciente regresa de otro servicio.'],
  ...
  function addPlainLanguageLayer(lessonId, lead, bridges) {
    var narrative = model.narratives[lessonId];
  ...
  addPlainLanguageLayer(
    ...
    'Esta clase responde a una pregunta sencilla: ¿qué hace una célula cuando necesita poder reductor para la defensa antioxidante o material para fabricar nucleótidos? La vía de las pentosas toma glucosa-6-fosfato y puede producir NADPH, ribosa-5-fosfato o intermediarios que regresan a la glucólisis. Para entenderla, primero se sigue la fase oxidativa y después se cuentan los carbonos en la fase reversible.',
    [
      'No pienses en esta vía como otra forma de fabricar ATP. Sus dos resultados principales son NADPH para reacciones reductoras y ribosa-5-fosfato para construir nucleótidos.',
      'La primera reacción funciona como la puerta de entrada. G6PD toma electrones de la glucosa-6-fosfato y los entrega a NADP+, que se transforma en NADPH.',
      'La fase oxidativa ocurre en un solo sentido. Al terminar, cada glucosa-6-fosfato de seis carbonos produce dos NADPH, libera un carbono como CO₂ y deja una pentosa-5-fosfato de cinco carbonos.',
      'La profesora agrupa tres moléculas para poder mostrar el intercambio completo de carbonos. No significa que una glucosa sola sea incapaz de entrar en la vía.',
      'Antes de intercambiar carbonos, las tres pentosas-5-fosfato se preparan en formas diferentes. Dos se convierten en xilulosa-5-fosfato y una en ribosa-5-fosfato para ofrecer los sustratos adecuados.',
      'En esta etapa imagina piezas de carbono que cambian de molécula. Transcetolasa mueve un bloque de dos carbonos y transaldolasa mueve uno de tres.',
      'La fase no oxidativa no destruye carbonos: reorganiza quince carbonos de tres pentosas-5-fosfato en doce carbonos de dos fructosas-6-fosfato y tres de un gliceraldehído-3-fosfato.',
      'Si la prioridad es fabricar nucleótidos, la célula conserva o produce ribosa-5-fosfato. La dirección de las reacciones cambia según cuánto NADPH necesita al mismo tiempo.',
      'Si la prioridad es producir mucho NADPH, los carbonos se reciclan hacia glucosa-6-fosfato para volver a pasar por la fase oxidativa y obtener más poder reductor.',
      'NADPH entrega electrones; ATP entrega energía utilizable. Esa diferencia explica por qué la vía protege al eritrocito sin ser una fuente directa de ATP.',
      'La indicación para la siguiente clase conecta estructura con función. La orientación del grupo hidroxilo del carbono anomérico permite distinguir α de β y entender qué enlaces forman el glucógeno.',
      'La preparación grupal sirve para ordenar ideas, pero la explicación final debe ser individual y salir de la memoria. Conviene practicar cada paso con sustrato, enzima, producto y balance.'
    ]
  );

  addPlainLanguageLayer(
    'epidemiologia-2026-08-28',
    'Esta clase explica cómo una persona debería avanzar por el sistema de salud paraguayo sin perder continuidad. Primero se reconocen los distintos subsistemas. Después se organizan establecimientos en redes, microredes y niveles según lo que realmente pueden resolver. Al final se comparan Manchester, el método START —del inglés Simple Triage and Rapid Treatment, «triaje simple y tratamiento rápido»— y el método SHORT —Sale caminando, Habla sin dificultad, Obedece órdenes sencillas, Respira y Taponar hemorragias—, tres herramientas de prioridad que no se usan en el mismo contexto.',
    [
      'Empieza con una idea: Paraguay no tiene un único proveedor de salud. Varias instituciones atienden grupos diferentes y utilizan reglas y formas de financiamiento propias.',
      'El MSPBS conduce la política sanitaria y mantiene una red pública. Sin embargo, la capacidad real de un establecimiento depende de recursos disponibles en ese momento.',
      'IPS, Hospital de Clínicas, sanidad institucional y sector privado no son nombres equivalentes. Cada uno tiene población cubierta, función y reglas de acceso específicas.',
      'RIISS significa redes integradas e integrales de servicios de salud. La palabra clave es conexión: territorio, información, responsabilidades y seguimiento deben acompañar al paciente.',
      'Una microred organiza servicios próximos dentro de un territorio. Conocer población, caminos y barreras permite decidir dónde resolver y cuándo derivar.',
      'El nivel no describe solo el tamaño del edificio. Expresa qué personal, capacidad diagnóstica, capacidad de internación y tecnología están realmente disponibles para resolver un problema.',
      'El primer nivel está cerca de la comunidad. Previene, atiende problemas frecuentes, detecta riesgo y conserva el seguimiento después de una derivación.',
      'Segundo y tercer nivel amplían especialidades, estudios y hospitalización. La diferencia útil es la capacidad resolutiva concreta, no solamente el nombre escrito en el hospital.',
      'El cuarto nivel concentra servicios altamente especializados. Como suele estar centralizado y puede quedar lejos, una derivación segura necesita coordinación, aceptación y transporte apropiado.',
      'La red clínica no funciona solo con consultorios. Laboratorio, imágenes, farmacia, sangre, comunicación, información y transporte sostienen el recorrido del paciente.',
      'Manchester se usa en urgencias habituales. El método START —del inglés Simple Triage and Rapid Treatment, «triaje simple y tratamiento rápido»— y el método SHORT —Sale caminando, Habla sin dificultad, Obedece órdenes sencillas, Respira y Taponar hemorragias— se diseñaron para múltiples víctimas. Los tres priorizan, pero sus preguntas y contextos no deben mezclarse.',
      'Durante la práctica, primero identifica qué algoritmo pide la ficha. Después sigue sus pasos en orden, asigna la prioridad y justifica la decisión solo con los datos disponibles.'
    ]
  );
