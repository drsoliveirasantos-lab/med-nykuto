(function(){
  ...
  var currentView='inicio',taskFilter='active',noticeCarouselController=null,requestedTaskId=String(new URLSearchParams(location.search).get('task')||'').trim();
