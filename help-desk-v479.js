    ...
    return ''+
      '<div class="helpdesk-form-fields" data-helpdesk-fields>'+
        '<div class="helpdesk-field-grid">'+
          '<label class="helpdesk-field" for="'+prefix+'Role"><span>¿Quién eres? <b>Obligatorio</b></span><select id="'+prefix+'Role" name="role" required>'+optionMarkup(roleOptions)+'</select></label>'+
          '<label class="helpdesk-field" for="'+prefix+'Category"><span>Tipo de consulta <b>Obligatorio</b></span><select id="'+prefix+'Category" name="category" required>'+optionMarkup(categoryOptions)+'</select></label>'+
          '<label class="helpdesk-field" for="'+prefix+'Location"><span>¿Dónde ocurre? <b>Obligatorio</b></span><select id="'+prefix+'Location" name="location" required>'+optionMarkup(locationOptions)+'</select></label>'+
          '<label class="helpdesk-field" for="'+prefix+'Subject"><span>Materia <em>Opcional</em></span><input id="'+prefix+'Subject" name="subject" type="text" maxlength="100" autocomplete="off" placeholder="Ej.: Fisiología" /></label>'+
          '<label class="helpdesk-field" for="'+prefix+'Name"><span>Tu nombre <em>Opcional</em></span><input id="'+prefix+'Name" name="name" type="text" maxlength="100" autocomplete="name" placeholder="Para saber cómo llamarte" /></label>'+
          '<label class="helpdesk-field" for="'+prefix+'ReplyContact"><span>Correo o WhatsApp <em>Opcional</em></span><input id="'+prefix+'ReplyContact" name="replyContact" type="text" maxlength="120" autocomplete="off" aria-describedby="'+prefix+'ReplyHelp" placeholder="Si quieres recibir una respuesta" /><small id="'+prefix+'ReplyHelp">Escribe un correo o un número de WhatsApp válido.</small></label>'+
          '<label class="helpdesk-field helpdesk-field-wide" for="'+prefix+'Message"><span>Describe lo que necesitas <b>Obligatorio</b></span><textarea id="'+prefix+'Message" name="message" minlength="10" maxlength="3000" rows="5" required aria-describedby="'+prefix+'MessageHelp '+prefix+'Safety" placeholder="Explica qué ocurre, qué esperabas ver y cualquier detalle útil."></textarea><small id="'+prefix+'MessageHelp">Entre 10 y 3.000 caracteres.</small></label>'+
        '</div>'+
        '<label class="helpdesk-honeypot" aria-hidden="true" for="'+prefix+'Website">No completar<input id="'+prefix+'Website" name="website" type="text" tabindex="-1" autocomplete="off" /></label>'+
