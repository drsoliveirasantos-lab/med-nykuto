(function(){
  ...
  var ptByEs = {
    ...
    'Instructivo oficial':'Instruções oficiais',
    'Modelo de portada':'Modelo de capa',
    '3 PÁGINAS':'3 PÁGINAS',
    '2 PÁGINAS':'2 PÁGINAS',
    'Instructivo de presentación oral':'Instruções para a apresentação oral',
    'Consignas, estructura, criterios de evaluación y organización de los dos trabajos.':'Orientações, estrutura, critérios de avaliação e organização dos dois trabalhos.',
    'Base oficial para completar los datos del grupo y presentar el desarrollo del trabajo.':'Base oficial para preencher os dados do grupo e apresentar o desenvolvimento do trabalho.',
    ...
    'Modelo de portada y desarrollo':'Modelo de capa e desenvolvimento'
  };
  ...
  var attributeTranslations = {
    ...
    'Tres páginas del instructivo':'Três páginas das instruções',
    'Dos páginas del modelo de portada':'Duas páginas do modelo de capa',
    'Página 1 del instructivo de presentación oral':'Página 1 das instruções para a apresentação oral',
    'Página 2 del instructivo de presentación oral':'Página 2 das instruções para a apresentação oral',
    'Página 3 del instructivo de presentación oral':'Página 3 das instruções para a apresentação oral',
    'Página 1 del modelo de portada':'Página 1 do modelo de capa',
    'Página 2 del modelo de portada':'Página 2 do modelo de capa',
    'Cerrar respuesta':'Fechar resposta',
