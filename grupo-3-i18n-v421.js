(function(){
  ...
  var ptByEs = {
    ...
    'El día resaltado indica la próxima jornada con clases.':'O dia destacado indica a próxima jornada com aulas.',
    ...
    'La profesora pidió leer el material por colores para la próxima clase. La transcripción no indica la fecha exacta, por eso permanece estimada.':'A professora pediu a leitura do material por cores para a próxima aula. A transcrição não informa a data exata, por isso ela permanece estimada.',
    ...
    'EXPLICACIÓN DEL MAPA':'EXPLICAÇÃO DO MAPA',
