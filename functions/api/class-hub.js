...
const DEFAULT_CURRENT_NOTICES = Object.freeze([
  ...
  },
  {
    ...
    imageUrl: 'https://med.nykuto.com/assets/class-hub/notices/2026-08-27/carnet-estudiantil.webp',
    imageAlt: 'Comunicado oficial sobre la toma de fotos para el carnet estudiantil del 24 al 28 de agosto',
  ...
  },
  {
    ...
    imageUrl: 'https://med.nykuto.com/assets/class-hub/notices/2026-08-27/atencion-alumno-hu.webp',
    imageAlt: 'Comunicado oficial sobre la atención restringida en el Hospital Universitario',
  ...
  },
  {
    ...
    imageUrl: 'https://med.nykuto.com/assets/class-hub/notices/2026-08-27/asistencia-biometrica.webp',
    imageAlt: 'Comunicado oficial sobre el registro obligatorio de asistencia biométrica',
    sourceLabel: 'Ver comunicado UCP',
  ...
  },
  {
    ...
    expiresAt: '2026-12-06T00:00:00-03:00',
    imageUrl: 'https://med.nykuto.com/assets/class-hub/notices/2026-08-27/proceso-integrado-cargas.webp',
    imageAlt: 'Matriz oficial de actividades y porcentajes del Proceso Integrado',
  ...
  },
  {
    ...
    expiresAt: '2026-12-06T00:00:00-03:00',
    imageUrl: 'https://med.nykuto.com/assets/class-hub/notices/2026-08-27/transporte-universitario.webp',
    imageAlt: 'Comunicado oficial sobre el transporte universitario y la última salida a las 20:30',
...
const DEFAULT_PUBLIC = {
  ...
  lessons: [],
  notices: DEFAULT_CURRENT_NOTICES.map((notice) => ({ ...notice, imageUrl: notice.imageUrl || null, imageAlt: notice.imageAlt || null, attachmentUploadId: null, attachmentUrl: null, attachmentTitle: null, attachmentMimeType: null, attachmentSizeBytes: null })),
  tasks: [],
  activities: [],
  groups: []
};
...
async function ensureSchema(db) {
  if (!schemaPromise) schemaPromise = (async () => {
    ...
    await db.batch([
      ...
      ...DEFAULT_CURRENT_NOTICES.map((notice) => db.prepare(`INSERT OR IGNORE INTO hub_notices (id,class_id,course,title,body,priority,status,push_mode,image_url,image_alt,category,lifecycle,audience,effective_at,expires_at,source_label,source_url,target_type,target_id,created_by,created_at,updated_at,published_at) VALUES (?,?,?,?,?,?,'published',0,?,?,?,?,?,?,?,?,?,?,?,'system',?,?,?)`).bind(notice.id, DEFAULT_CLASS_ID, notice.course, notice.title, notice.body, notice.priority, notice.imageUrl || null, notice.imageAlt || null, notice.category, notice.lifecycle, notice.audience, notice.effectiveAt, notice.expiresAt, notice.sourceLabel, notice.sourceUrl, notice.targetType, notice.targetId, notice.publishedAt, notice.publishedAt, notice.publishedAt)),
