...
/* v282 — Lazy practice bank loader
...
(function(){
  ...
  for(var i=0; i<wanted.length; i++){
    ...
    if(!file) continue;
    if(window.MED_PRACTICE_BANK.byCourse && window.MED_PRACTICE_BANK.byCourse[id]) continue;
    document.write('<script src="data/' + file + '?v=282"><\/script>');
  }
