/* v347 — Lazy practice bank loader
   ...
   v347 chains count-safe quality patches after the corresponding bank file.
*/
(function(){
  "use strict";
  ...
  function loadDataScript(path){
    document.write('<scr' + 'ipt src="data/' + path + '?v=347"></scr' + 'ipt>');
  }
