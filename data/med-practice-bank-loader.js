/* v372 — Lazy practice bank loader with complete runtime quality validation.
...
(function(){
  ...
  if(wanted.length) loadDataScript("practice-bank-answer-length-patch-v372.js");
  window.MED_PRACTICE_BANK_LOADING = false;
  window.__MED_NYKUTO_PRACTICE_LOADER__ = "v372";
})();
