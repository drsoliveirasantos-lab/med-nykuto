/* v461 — Lazy practice bank loader with Semester 3 course certification.
...
(function(){
  ...
  if(wanted.length) loadDataScript("practice-bank-s3-certification-v461.js");
  window.MED_PRACTICE_BANK_LOADING = false;
  window.__MED_NYKUTO_PRACTICE_LOADER__ = "v461";
})();
